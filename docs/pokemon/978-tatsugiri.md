<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/tatsugiri.png" width="100"/>
...
=== "Level Up Moves"
	...
	| 23 | Soak | - | 100 | 20 | ![water](../img/types/water.png) | ![status](../img/types/status.png) |
	| 34 | Memento | - | 100 | 10 | ![dark](../img/types/dark.png) | ![status](../img/types/status.png) |
