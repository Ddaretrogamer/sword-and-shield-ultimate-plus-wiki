<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/kingambit.png" width="100"/>
  ...
  <div>
    ...
    <div style="display: flex; flex-direction: row; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        ...
        /<a href='' title="Increases super-effective damage dealt to 1.25x.">Supreme-overlord</a>
      </div>
    </div>
  </div>
</div>
...
=== "Level Up Moves"
	...
	| 15 | Torment | - | 100 | 15 | ![dark](../img/types/dark.png) | ![status](../img/types/status.png) |
	| 25 | Assurance | 60 | 100 | 10 | ![dark](../img/types/dark.png) | ![physical](../img/types/physical.png) |
	| 30 | Metal-sound | - | 85 | 40 | ![steel](../img/types/steel.png) | ![status](../img/types/status.png) |
