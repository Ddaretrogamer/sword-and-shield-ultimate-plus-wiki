<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/pecharunt.png" width="100"/>
  ...
  <div style="display: grid; grid-template-rows: 1fr 1fr 1fr; row-gap: 0.5rem;">
    ...
    <div style="display: grid; grid-template-columns: 100px auto; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        <a href='' title="Pokémon poisoned by Pecharunt's moves will also become confused.">Poison-puppeteer</a>
...
=== "Level Up Moves"
	...
	| 8 | Withdraw | - | - | 40 | ![water](../img/types/water.png) | ![status](../img/types/status.png) |
	| 16 | Destiny-bond | - | - | 5 | ![ghost](../img/types/ghost.png) | ![status](../img/types/status.png) |
	| 32 | Parting-shot | - | 100 | 20 | ![dark](../img/types/dark.png) | ![status](../img/types/status.png) |
...
=== "Machine Moves"
	...
	| TM03 | Curse | - | - | 10 | ![ghost](../img/types/ghost.png) | ![status](../img/types/status.png) |
