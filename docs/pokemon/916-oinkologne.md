<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/oinkologne.png" width="100"/>
  ...
  <div style="display: grid; grid-template-rows: 1fr 1fr 1fr; row-gap: 0.5rem;">
    ...
    <div style="display: grid; grid-template-columns: 100px auto; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        <a href='' title="Increases super-effective damage dealt to 1.25x.">Lingering-aroma</a>
...
=== "Level Up Moves"
	...
	| 8 | Echoed-voice | 40 | 100 | 15 | ![normal](../img/types/normal.png) | ![special](../img/types/special.png) |
	| 15 | Covet | 60 | 100 | 25 | ![normal](../img/types/normal.png) | ![physical](../img/types/physical.png) |
	| 23 | Headbutt | 70 | 100 | 15 | ![normal](../img/types/normal.png) | ![physical](../img/types/physical.png) |
	| 27 | Yawn | - | - | 10 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 34 | Work-up | - | - | 30 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	...
	| 54 | Belch | 120 | 90 | 10 | ![poison](../img/types/poison.png) | ![special](../img/types/special.png) |
