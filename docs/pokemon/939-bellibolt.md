<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/bellibolt.png" width="100"/>
  ...
  <div style="display: grid; grid-template-rows: 1fr 1fr 1fr; row-gap: 0.5rem;">
    ...
    <div style="display: grid; grid-template-columns: 100px auto; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        <a href='' title="Increases super-effective damage dealt to 1.25x.">Electromorphosis</a>
...
=== "Level Up Moves"
	...
	| 17 | Charge | - | - | 20 | ![electric](../img/types/electric.png) | ![status](../img/types/status.png) |
	| 21 | Spark | 65 | 100 | 20 | ![electric](../img/types/electric.png) | ![physical](../img/types/physical.png) |
	...
	| 36 | Weather-ball | 50 | 100 | 10 | ![normal](../img/types/normal.png) | ![special](../img/types/special.png) |
	| 45 | Sucker-punch | 70 | 100 | 5 | ![dark](../img/types/dark.png) | ![physical](../img/types/physical.png) |
	| 50 | Zap-cannon | 120 | 50 | 5 | ![electric](../img/types/electric.png) | ![special](../img/types/special.png) |
