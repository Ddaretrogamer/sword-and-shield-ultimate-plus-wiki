<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/chi-yu.png" width="100"/>
  ...
  <div style="display: grid; grid-template-rows: 1fr 1fr 1fr; row-gap: 0.5rem;">
    ...
    <div style="display: grid; grid-template-columns: 100px auto; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        <a href='' title="Increases super-effective damage dealt to 1.25x.">Beads-of-ruin</a>
        /<a href='' title="Increases super-effective damage dealt to 1.25x.">Beads-of-ruin</a>
      </div>
    </div>
...
=== "Level Up Moves"
	...
	| 5 | Flame-wheel | 60 | 100 | 25 | ![fire](../img/types/fire.png) | ![physical](../img/types/physical.png) |
	...
	| 45 | Lava-plume | 80 | 100 | 15 | ![fire](../img/types/fire.png) | ![special](../img/types/special.png) |
	| 50 | Ruination | 1 | 90 | 10 | ![dark](../img/types/dark.png) | ![special](../img/types/special.png) |
	| 55 | Bounce | 85 | 85 | 5 | ![flying](../img/types/flying.png) | ![physical](../img/types/physical.png) |
	| 60 | Swagger | - | 85 | 15 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
