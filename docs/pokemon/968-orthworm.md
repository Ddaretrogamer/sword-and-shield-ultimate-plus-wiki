<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/orthworm.png" width="100"/>
  ...
  <div>
    ...
    <div style="display: flex; flex-direction: row; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        <a href='' title="Increases super-effective damage dealt to 1.25x.">Earth-eater</a>
...
=== "Level Up Moves"
	...
	| 12 | Smack-down | 50 | 100 | 15 | ![rock](../img/types/rock.png) | ![physical](../img/types/physical.png) |
	| 43 | Iron-tail | 100 | 75 | 15 | ![steel](../img/types/steel.png) | ![physical](../img/types/physical.png) |
	| 52 | Shed-tail | 0 | - | 10 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
