<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/miraidon.png" width="100"/>
  ...
  <div style="display: grid; grid-template-rows: 1fr 1fr 1fr; row-gap: 0.5rem;">
    ...
    <div style="display: grid; grid-template-columns: 100px auto; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        <a href='' title="Increases super-effective damage dealt to 1.25x.">Hadron-engine</a>
        /<a href='' title="Increases super-effective damage dealt to 1.25x.">Hadron-engine</a>
      </div>
    </div>
...
=== "Level Up Moves"
	...
	| 7 | Shock-wave | 60 | - | 20 | ![electric](../img/types/electric.png) | ![special](../img/types/special.png) |
	| 14 | Charge | - | - | 20 | ![electric](../img/types/electric.png) | ![status](../img/types/status.png) |
	| 21 | Parabolic-charge | 65 | 100 | 20 | ![electric](../img/types/electric.png) | ![special](../img/types/special.png) |
	| 28 | Discharge | 80 | 100 | 15 | ![electric](../img/types/electric.png) | ![special](../img/types/special.png) |
	| 56 | Electro-drift | 100 | 100 | 5 | ![electric](../img/types/electric.png) | ![special](../img/types/special.png) |
	| 63 | Metal-sound | - | 85 | 40 | ![steel](../img/types/steel.png) | ![status](../img/types/status.png) |
	| 70 | Mirror-coat | - | 100 | 20 | ![psychic](../img/types/psychic.png) | ![special](../img/types/special.png) |
